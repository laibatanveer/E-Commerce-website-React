        ...
        <div className="container py-4">
          <div className="row">
            ...
            <p className="footer-description text-center text-white col-md-4">
              Stay connected with Beautify App on social media and via email.
              Join us to discover the latest beauty trends, tips, and
              inspiration.
            </p>
            <div className="col-md-4">
              <div className=" d-flex justify-content-center">
                <ul>
                  <li>
                    <Link to="#" className="link-light footer-icon mx-2">
                      <FaInstagram />
                    </Link>
                  </li>
                  <li>
